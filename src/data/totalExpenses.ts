import { IGroupedData } from '@components/GroupedBarChart'

export const TOTAL_EXPENSES: IGroupedData[] = [
  ...
  { label: '2026', values: [45.53] },
  { label: '2027', values: [46.55] },
]
